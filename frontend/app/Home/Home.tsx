  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.topBar}>
        <TouchableOpacity style={styles.topButton} onPress={handleSort}><Text style={styles.topButtonText}>Sort</Text></TouchableOpacity>
        <TouchableOpacity style={styles.topButton} onPress={handleFilter}><Text style={styles.topButtonText}>Filter</Text></TouchableOpacity>
      </View>
      ...
      <View style={styles.scrollContainer}>
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          {climbs.map((climb) => (
            <TouchableOpacity key={climb.id} style={styles.card} onPress={() => handlePressClimb(climb)}>
